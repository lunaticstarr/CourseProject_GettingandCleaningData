...
Here, the project cleans the data collected from the experiments and
...
3. Run the script ("Script for performing the analysis.R").  
4. The script will automatically output two files in your working directory: 
* "TidyDataset.csv"--the tidy version of the dataset which contains only the measurements on the mean and standard deviation for each measurement.  
* "TidyAverage.csv"--a tidy data set with the average of each variable for each activity and each subject.  
